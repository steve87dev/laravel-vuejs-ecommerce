...
<body>
    <div id="adminApp">
        ...
        @else
            <div class="container">
        <div class="topnav">
            <a class="{{ Request::path() == 'admin' ? 'active' : '' }}" href="{{route('admin.home')}}">Products</a>
            <a class="{{ Request::path() == 'admin/users' ? 'active' : '' }}" href="{{route('admin.users')}}">Users</a>
        </div>
            </div>
        @endguest
        <main class="py-4">
